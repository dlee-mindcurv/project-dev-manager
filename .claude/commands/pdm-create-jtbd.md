...
2. **Feature Idea**: @product-development/features/$ARGUMENTS/feature.md (to understand the feature idea)
...
3. Output the JTBD document to `product-development/features/$ARGUMENTS/jtbd.md`

4. After successfully creating the JTBD document, invoke `/pdm-create-prd $ARGUMENTS` to generate the PRD.
